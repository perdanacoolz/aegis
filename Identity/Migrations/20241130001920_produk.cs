        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    jenis_produk = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ProdukId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Produks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Produks_Produks_ProdukId",
                        column: x => x.ProdukId,
